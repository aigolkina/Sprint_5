...
class TestAuth:
    def test_auth_valid(self):
        ...
        driver.find_element(By.TAG_NAME, "input").send_keys("Анастасия1")  # Найти поле "Имя" и ввести данные

        driver.find_element(By.XPATH, "//*[@id=\"root\"]/div/main/div/form/fieldset[2]/div/div/input").click() # Найти поле "Email" и тапнуть на него
        driver.find_element(By.XPATH, "//*[@id=\"root\"]/div/main/div/form/fieldset[2]/div/div/input").send_keys("anastasia_igolkina11_3333@mail.ru") # Найти поле "Email" и ввести данные
        ...
        label = driver.find_element(By.XPATH, "//*[@id=\"root\"]/div/main/div/form/button") # Найти слово "Войти"
